<x-app-layout>
    <x-slot name="hero">
        <div class="relative">
            <div class="mx-auto max-w-7xl w-full text-center py-16 lg:text-left">
            ...
            <div class="hidden lg:block absolute inset-y-0 right-0 w-1/2 h-full">
                <div class="py-16 h-full relative">
                    <img class="absolute inset-0 w-full h-full object-contain" src="{{ asset('img/hero.png') }}" alt="">
                </div>
            </div>
        </div>
    </x-slot>
