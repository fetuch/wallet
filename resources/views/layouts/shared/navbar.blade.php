    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="flex justify-between items-center py-6 md:justify-start md:space-x-10">
            <div class="flex justify-start lg:w-0 lg:flex-1">
                <a href="{{ route('homepage') }}" class="flex flex-row">
                    <span class="sr-only">Workflow</span>
                    <img class="h-8 w-auto sm:h-10" src="{{ asset('img/wallet.svg') }}" alt="">
                    <span class="ml-3 self-center text-base font-medium text-gray-500 hover:text-gray-900">App Name</span>
                </a>
            </div>
